      ...
      statusMessage.innerHTML = `
        <div style="display: flex;">
          <svg xmlns="http://www.w3.org/2000/svg"
            ...
            role="img"
            aria-label="Warning:">
            <path d="M8.982 1.566a1.13 1.13 0 0 1 1.96 0l6.817 11.667c.457.778-.091 1.767-.98 1.767H.2c-.889 0-1.438-.99-.98-1.767L6.038 1.566a1.13 1.13 0 0 1 1.96 0zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L6.55 5.995A.905.905 0 0 1 7.45 5H8zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
          </svg>
